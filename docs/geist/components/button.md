...
> Автозгенеровано з `Vercel_raw/geist-docs/vercel.com/geist/button.html` скриптом `scripts/geist/extract-components.mjs` (`npm run geist:components`). Не редагувати вручну.
