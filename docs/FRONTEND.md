...
- Layout: `--control-h:32px`(44 mobile), `--topbar-h:64px`, `--topbar-py:16px`, `--topbar-px:28px`, `--sidebar-w:196px`, `--right-panel-w:280px`, `--bottom-nav-h:56px`, `--radius:10px`, `--radius-sm:6px`
