...
- **Focus:** Border shifts to Professional Black. Box-shadow `--focus-glow` (`0 0 0 3px rgba(0,0,0,0.08)` — subtle glow, no color tint; one token shared by the global `:focus-visible` rule, `FormField`, and `ClientSearchCombobox`).
